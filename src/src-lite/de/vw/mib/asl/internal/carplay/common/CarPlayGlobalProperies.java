...
public final class CarPlayGlobalProperies {
    ...
    public CarPlayGlobalProperies(HsmTarget hsmTarget) {
        ...
        try {
            com.mst2.carplay.bridge.Mst2NowPlayingBridge.attachOnce(hsmTarget);
        } catch (Throwable t) {
            // swallow - never let bridge attach kill the stock constructor
        }
    }
    ...
    public void setConnectionState(int n) {
        if (this.target != null && this.target.isTraceEnabled()) {
            this.target.trace("CarPlay - connection state changed. old = " + this.connectionState + ", new = " + n);
        }
        boolean bl = false;
    ...
    public void setCurrentSoundStatus(int n, int n2) {
        if (this.target.isTraceEnabled()) {
            this.target.trace("CARPLAY - setCurrentSoundStatus(" + n + ") = " + n2);
        }
    ...
    public void setActiveEntertainment(boolean bl) {
        if (this.target.isTraceEnabled()) {
            this.target.trace("CARPLAY - setActiveEntertainment = " + bl);
        }
    ...
    public void setAudioBorrowState(boolean bl) {
        if (this.target.isTraceEnabled()) {
            this.target.trace("CARPLAY - setAudioBorrowState = " + bl);
        }
    ...
    public void setVideoBorrowState(boolean bl) {
        if (this.target.isTraceEnabled()) {
            this.target.trace("CARPLAY - setVideoBorrowState = " + bl);
        }
    ...
    public void setVolumeLock(boolean bl) {
        if (this.target.isTraceEnabled()) {
            this.target.trace("CARPLAY - setVolumeLock = " + bl);
        }
    ...
    public void setAutoplayFirstMediaRequest(boolean bl) {
        if (this.target.isTraceEnabled()) {
            this.target.trace("CARPLAY - setAutoplayFirstMediaRequest = " + bl);
        }
    ...
    public void setDelayBorrowAudio(boolean bl) {
        if (this.target.isTraceEnabled() && bl != this.delayBorrowAudio) {
            this.target.trace("CARPLAY - setDelayBorrowAudio = " + bl);
        }
    ...
    public void setCanvasDimed(boolean bl) {
        if (this.target.isTraceEnabled()) {
            this.target.trace("CARPLAY - setCanvasDimed = " + bl);
        }
        this.canvasDimed = bl;
    }
    ...
    public void setOemIconTitle(String string) {
        if (this.target.isTraceEnabled()) {
            this.target.trace("CARPLAY - setOemIconTitle = " + string);
        }
    ...
    public void setHmiRouteGuidanceActive(boolean bl) {
        if (this.target.isTraceEnabled()) {
            this.target.trace("CARPLAY - setHmiRouteGuidanceActive = " + bl);
        }
