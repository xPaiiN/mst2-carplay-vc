...
ExboxServiceListener {
    ...
    private void setStationInfoForMirrorLink(CurrentStationInfo_Status currentStationInfo_Status) {
        ...
        if (connectionType == 2) {
            ...
            // Lde-junk pre-filter: never push a CFR decompiler artifact into the VC.
    ...
    // Pre-filter strings that look like a CFR decompiler artifact leaked through a Stock-Bytecode
